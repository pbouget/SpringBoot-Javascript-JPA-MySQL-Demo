...
/**
 * 
 * Controller apprenant pour test
 *
 */
@RestController
@RequestMapping("/api")
public class ApprenantController {
	...
	/**
	 * Méthode qui retourne tous les apprenants
	 * @return
	 */
	...
	/**
	 * Rechercher un apprenant par son id
	 * @param id
	 * @return
	 */
	...
	public ResponseEntity<?> getApprenant(@PathVariable Integer id){
		...
		if(apprenant.isEmpty())
			return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Apprenant.e introuvable !");
	...
	/**
	 * Mettre à jour les attributs d'un apprenant
	 * @param apprenant
	 * @param id
	 * @return
	 * @throws Exception
